    ...
    return (
        ...
        <div className="cardm">
            ...
            <svg
                ...
                xmlSpace="preserve" >
                {" "}
                <image id="image0" width={100} height={100} x={-10} y={0}
            ...
            <div className="main">{Math.round(city.temp)}° C</div>
            <div className="mainsub">{city.name}</div>
            ...
            Ut8AAAAASUVORK5CYII="
                ...
                <div className="card3">{city.description}</div>
            </div>
            </div>
        </div>
